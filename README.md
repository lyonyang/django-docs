...
基于种种的原因 , 我实在是不想再用它了 , 当然它的技术层次还是很棒的 , 可能由于作者是国外的 , 也许国外编写 API 的方式和国内太不一样 ? 总之我受够了 , 弃用吧 
...
- [1 - 快速开始](https://github.com/lyonyang/django-api-docs/blob/master/document/1%20-%20Quickstart.md)
